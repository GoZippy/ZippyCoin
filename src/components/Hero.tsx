  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-crypto-dark-950 via-crypto-dark-900 to-crypto-dark-950">
        ...
        {/* Gradient orbs */}
        <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-zippy-500/5 rounded-full blur-3xl animate-float"></div>
        <div className="absolute bottom-1/4 right-1/4 w-80 h-80 bg-quantum-500/5 rounded-full blur-3xl animate-float" style={{ animationDelay: '2s' }}></div>
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-zippy-400/3 rounded-full blur-2xl animate-pulse-slow"></div>
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          {/* Status Badge */}
          <motion.div
            className="inline-flex items-center px-6 py-3 rounded-full bg-crypto-dark-800/60 backdrop-blur-sm border border-zippy-500/20 text-zippy-300 text-sm font-medium mb-8 shadow-lg"
          ...
          >
            ...
            <a
              ...
              className="inline-flex items-center space-x-2 text-zippy-400 hover:text-zippy-300 transition-colors group"
            >
      ...
      >
        <div className="w-6 h-10 border-2 border-crypto-dark-600/50 rounded-full flex justify-center">
          <motion.div
